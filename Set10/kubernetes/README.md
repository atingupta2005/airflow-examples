...
Code accompanying the Kubernetes part of Set 10

## Contents

This directory contains the Kubernetes equivalent of the recommender system demonstrated in the set10_1_docker example.
...
as well as the recommender API service:
    ...
    docker build -t manning-airflow/movielens-api ../set08/docker/movielens-api
